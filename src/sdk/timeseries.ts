        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.clientFacingBloodPressureTimeseries = plainToInstance(
                ,
                httpRes?.data as ,
  ...
  getTimeseriesResourceDataV2TimeseriesUserIdResourceGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.clientFacingTimeseries = plainToInstance(
                ,
                httpRes?.data as ,
                { excludeExtraneousValues: true }
              );
  ...
  getTimeseriesResourceDataV2TimeseriesUserIdBloodOxygenGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.clientFacingBloodOxygenTimeseries = plainToInstance(
                ,
                httpRes?.data as ,
                { excludeExtraneousValues: true }
              );
  ...
  getTimeseriesResourceDataV2TimeseriesUserIdCaffeineGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.clientFacingCaffeineTimeseries = plainToInstance(
                ,
                httpRes?.data as ,
                { excludeExtraneousValues: true }
              );
  ...
  getTimeseriesResourceDataV2TimeseriesUserIdCholesterolGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.clientFacingCholesterolTimeseries = plainToInstance(
                ,
                httpRes?.data as ,
                { excludeExtraneousValues: true }
              );
  ...
  getTimeseriesResourceDataV2TimeseriesUserIdGlucoseGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.clientFacingGlucoseTimeseries = plainToInstance(
                ,
                httpRes?.data as ,
                { excludeExtraneousValues: true }
              );
  ...
  getTimeseriesResourceDataV2TimeseriesUserIdHeartrateGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.clientFacingHeartRateTimeseries = plainToInstance(
                ,
                httpRes?.data as ,
                { excludeExtraneousValues: true }
              );
  ...
  getTimeseriesResourceDataV2TimeseriesUserIdHeartrateVariabilityGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.clientFacingHRVTimeseries = plainToInstance(
                ,
                httpRes?.data as ,
                { excludeExtraneousValues: true }
              );
  ...
  getTimeseriesResourceDataV2TimeseriesUserIdHypnogramGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.clientFacingHypnogramTimeseries = plainToInstance(
                ,
                httpRes?.data as ,
                { excludeExtraneousValues: true }
              );
  ...
  getTimeseriesResourceDataV2TimeseriesUserIdIgeGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.clientFacingIgeTimeseries = plainToInstance(
                ,
                httpRes?.data as ,
                { excludeExtraneousValues: true }
              );
  ...
  getTimeseriesResourceDataV2TimeseriesUserIdIggGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.clientFacingIggTimeseries = plainToInstance(
                ,
                httpRes?.data as ,
                { excludeExtraneousValues: true }
              );
  ...
  getTimeseriesResourceDataV2TimeseriesUserIdMindfulnessMinutesGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.clientFacingMindfulnessMinutesTimeseries = plainToInstance(
                ,
                httpRes?.data as ,
                { excludeExtraneousValues: true }
              );
  ...
  getTimeseriesResourceDataV2TimeseriesUserIdRespiratoryRateGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.clientFacingRespiratoryRateTimeseries = plainToInstance(
                ,
                httpRes?.data as ,
                { excludeExtraneousValues: true }
              );
  ...
  getTimeseriesResourceDataV2TimeseriesUserIdStepsGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.clientFacingStepsTimeseries = plainToInstance(
                ,
                httpRes?.data as ,
                { excludeExtraneousValues: true }
              );
  ...
  getTimeseriesResourceDataV2TimeseriesUserIdWaterGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.clientFacingWaterTimeseries = plainToInstance(
                ,
                httpRes?.data as ,
                { excludeExtraneousValues: true }
              );
  ...
  getUserSleepStreamV2TimeseriesSleepSleepIdStreamGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.clientFacingSleepStream = plainToInstance(
                shared.ClientFacingSleepStream,
                httpRes?.data as shared.ClientFacingSleepStream,
                { excludeExtraneousValues: true }
              );
            }
            break;
  ...
  getUserWorkoutsV2TimeseriesWorkoutsWorkoutIdStreamGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
              res.clientFacingStream = plainToInstance(
                shared.ClientFacingStream,
                httpRes?.data as shared.ClientFacingStream,
                { excludeExtraneousValues: true }
              );
            }
            break;
